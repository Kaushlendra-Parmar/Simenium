...
// Available models
const MODELS = [
    { name: 'dna.glb', displayName: 'DNA Structure' },
    { name: 'rna.glb', displayName: 'RNA Structure' }
];
...
function initThreeJS() {
    ...
    const directionalLight1 = new THREE.DirectionalLight(0xffffff, 2.45);
    directionalLight1.position.set(10, 20, 10);
    scene.add(directionalLight1);

    const directionalLight2 = new THREE.DirectionalLight(0xffffff, 1.75);
    ...
    const directionalLight4 = new THREE.DirectionalLight(0xffffff, 1.26);
    directionalLight4.position.set(-15, 5, 0);
    scene.add(directionalLight4);

    const directionalLight5 = new THREE.DirectionalLight(0xffffff, 1.05);
    ...
    const rectLight1 = new THREE.RectAreaLight(0xffffff, 0.84, 8, 8);
    rectLight1.position.set(0, 12, 0);
    rectLight1.lookAt(0, 0, 0);
    scene.add(rectLight1);

    const rectLight2 = new THREE.RectAreaLight(0xffffff, 0.7, 6, 6);
    rectLight2.position.set(8, 5, 8);
    rectLight2.lookAt(0, 0, 0);
    scene.add(rectLight2);

    const rectLight3 = new THREE.RectAreaLight(0xffffff, 0.56, 6, 6);
    rectLight3.position.set(-8, 5, -8);
    rectLight3.lookAt(0, 0, 0);
    scene.add(rectLight3);

    const rectLight4 = new THREE.RectAreaLight(0xffffff, 0.49, 5, 5);
    rectLight4.position.set(0, 3, 10);
    rectLight4.lookAt(0, 0, 0);
    scene.add(rectLight4);    const rectLight5 = new THREE.RectAreaLight(0xffffff, 0.42, 5, 5);
...
function loadModel(modelName) {
    ...
    loadedModels = [];    loader.load(
        ...
        (gltf) => {
            ...
            // Individual scaling for each DNA/RNA model
            if (modelName === 'dna.glb') {
                scale = 0.003; // Slightly smaller for DNA structure to fit better in view
            } else if (modelName === 'rna.glb') {
                scale = 0.003; // Larger for RNA structure for better detail visibility
            }
